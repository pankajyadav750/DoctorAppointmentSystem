...
public class PaymentConfirmedReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_payment_confirmed_report);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<getterSetterForBookingReq> options = new FirebaseRecyclerOptions.Builder<getterSetterForBookingReq>()
                ...
                .build();
        FirebaseRecyclerAdapter<getterSetterForBookingReq, PaymentConfirmedReportActivity.RequestViewHolder> adapter = new FirebaseRecyclerAdapter<getterSetterForBookingReq, PaymentConfirmedReportActivity.RequestViewHolder>(options)
        {
            @Override
            protected void onBindViewHolder(@NonNull final PaymentConfirmedReportActivity.RequestViewHolder requestViewHolder, int i, @NonNull final getterSetterForBookingReq contacts)
            {
            ...
            @NonNull
            @Override
            public PaymentConfirmedReportActivity.RequestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_request_inflate, parent, false);
                PaymentConfirmedReportActivity.RequestViewHolder holder = new PaymentConfirmedReportActivity.RequestViewHolder(view);
