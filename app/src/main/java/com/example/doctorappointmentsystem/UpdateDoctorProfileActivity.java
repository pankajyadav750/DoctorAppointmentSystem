...
public class UpdateDoctorProfileActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{

    private Button Set_doctor_profile;
    private TextView doctor_profile_dob;
    private DatePickerDialog.OnDateSetListener setListener;
    private EditText Set_doctor_name, Set_doctor_contact, Set_state, Set_distic,Set_Upi, Set_doctor_hospital, Set_doctor_education, Set_doctor_permanent_address,Set_doctor_expereance,Set_doctor_bio;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Set_Upi=findViewById(R.id.doctor_profile_upiId_edit);
        ...
        DoctorRef.child(currentDoctorId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if(dataSnapshot.exists())
                {
                    ...
                    String doctor_hospital_addr=dataSnapshot.child("hospital_address").getValue().toString();

                    String doctor_bio=dataSnapshot.child("Bio").getValue().toString();

                    //String doctor_upiId=dataSnapshot.child(" upiId").getValue().toString();
                  //  downLoadUrlPhoto=doctor_image;

                    Set_doctor_name.setText(doctor_name);
                    Set_doctor_hospital.setText(doctor_hospital);
                    Picasso.get().load(doctor_image).into(Set_doctor_profile_photo);
                    Set_doctor_education.setText(doctor_education);
                    Set_doctor_contact.setText(doctor_contact);
                    Set_doctor_permanent_address.setText(doctor_address);
                    Set_doctor_expereance.setText(doctor_experience);
                    Set_state.setText(doctor_hospital_addr);
                    Set_doctor_bio.setText(doctor_bio);
                    doctor_profile_dob.setText(doctor_dob);
                    Set_Doctor_specialist_in.setTooltipText(doctor_specialization);

                    if(doctor_gender.equals("male"))
                        ((RadioButton)findViewById(R.id.doctor_male)).setChecked(true);
                    else
                        ((RadioButton)findViewById(R.id.doctor_female)).setChecked(true);

                    Doctor_UPI.child(currentDoctorId).addValueEventListener(new ValueEventListener() {
                        @Override
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                        {
                            if (dataSnapshot.exists())
                            {
                                String upi=dataSnapshot.child("UPI_ID").getValue().toString();
                                Set_Upi.setText(upi);
                            }
        ...
        doctor_profile_dob.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog datePickerDialog = new DatePickerDialog(
                        UpdateDoctorProfileActivity.this, android.R.style.Theme_Holo_Dialog_MinWidth
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        filepath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                downLoadUrlPhot=downLoadUrlPhoto;
    ...
    private void setDoctorProfile() {
        ...
        /*if (TextUtils.isEmpty(downLoadUrlPhoto)) {
         ...
         */
          if (TextUtils.isEmpty(doctor_name)) {
            ...
            profileMap.put("image", downLoadUrlPhot);
