...
public class OurDoctorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        manage_doctor_RecyclerList=findViewById(R.id.our_doctor_list_Recycler_List);
        manage_doctor_RecyclerList.setLayoutManager(new LinearLayoutManager(this));
        manage_doctor_profile_toolbar=findViewById(R.id.our_doctor_manage_profile_toolbar);

        mAuth=FirebaseAuth.getInstance();
        //current_Doctor=mAuth.getCurrentUser().getUid();
        Doctor_ref= FirebaseDatabase.getInstance().getReference().child("Doctors");
        manage_doctor_profile_toolbar.setTitle("Ours doctors");
    }
    ...
    protected void onStart() {
        ...
        progressDialog.setMessage("work in progrss");
        progressDialog.show();
        ...
        FirebaseRecyclerOptions<Doctor_List> options = new FirebaseRecyclerOptions.Builder<Doctor_List>()
                ...
                .build();
        FirebaseRecyclerAdapter<Doctor_List, OurDoctorsActivity.FindsFriendsViewHolder> adapter =
                new FirebaseRecyclerAdapter<Doctor_List, OurDoctorsActivity.FindsFriendsViewHolder>(options) {
                    @Override
                    protected void onBindViewHolder(@NonNull OurDoctorsActivity.FindsFriendsViewHolder holder, final int position, @NonNull Doctor_List model) {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                Intent intent = new Intent(getApplicationContext(), PatientMeetDoctorProfileActivity.class);
                    ...
                    @NonNull
                    @Override
                    public OurDoctorsActivity.FindsFriendsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                        ...
                        OurDoctorsActivity.FindsFriendsViewHolder viewHolder = new OurDoctorsActivity.FindsFriendsViewHolder(view);
                        return viewHolder;
                    }
                };
