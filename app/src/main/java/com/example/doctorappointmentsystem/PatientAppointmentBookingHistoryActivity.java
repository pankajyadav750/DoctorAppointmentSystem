...
public class PatientAppointmentBookingHistoryActivity extends AppCompatActivity {

    private RecyclerView Doctor_Appointment_history_RecyclerList;
    ...
    private Toolbar Doctor_Appointment_history_toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patient_appointment_booking_history);

        progressDialog=new ProgressDialog(this);


        Doctor_Appointment_history_RecyclerList = findViewById(R.id.doctor_appointment_history_Recycler_List);
        Doctor_Appointment_history_RecyclerList.setLayoutManager(new LinearLayoutManager(this));

        Doctor_Appointment_history_toolbar = findViewById(R.id.Doctor_Appointment_history_toolbar_profile_toolbar);
        Doctor_Appointment_history_toolbar.setTitle("Appointment History");
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<getterSetterForBookingReq> options = new FirebaseRecyclerOptions.Builder<getterSetterForBookingReq>()
                ...
                .build();
        FirebaseRecyclerAdapter<getterSetterForBookingReq, PatientAppointmentBookingHistoryActivity.RequestViewHolder> adapter = new FirebaseRecyclerAdapter<getterSetterForBookingReq, PatientAppointmentBookingHistoryActivity.RequestViewHolder>(options)
        {
            @Override
            protected void onBindViewHolder(@NonNull final PatientAppointmentBookingHistoryActivity.RequestViewHolder requestViewHolder, final int i, @NonNull final getterSetterForBookingReq contacts)
            {
                                                ...
                                                if (dataSnapshot.exists())
                                                {
                                                    ...
                                                    requestViewHolder.itemView.setOnClickListener(new View.OnClickListener() {
                                                        ...
                                                        public void onClick(View view)
                                                        {
                                                            ...
                                                            Intent intent=new Intent(getApplicationContext(),PatientReportGenerateActivity.class);
            ...
            @NonNull
            @Override
            public PatientAppointmentBookingHistoryActivity.RequestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_request_inflate, parent, false);
                PatientAppointmentBookingHistoryActivity.RequestViewHolder holder = new PatientAppointmentBookingHistoryActivity.RequestViewHolder(view);
        ...
        Doctor_Appointment_history_RecyclerList.setAdapter(adapter);
