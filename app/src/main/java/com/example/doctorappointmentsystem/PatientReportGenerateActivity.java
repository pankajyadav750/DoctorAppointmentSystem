...
public class PatientReportGenerateActivity extends AppCompatActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    DoctorREF.child(Did).addValueEventListener(new ValueEventListener() {
      @Override
    ...
    PatientREF.child(current_patient).addValueEventListener(new ValueEventListener() {
      @Override
      public void onDataChange(@NonNull DataSnapshot dataSnapshot)
      {
        if (dataSnapshot.exists())
