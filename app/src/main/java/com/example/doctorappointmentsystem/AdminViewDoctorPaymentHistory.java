...
public class AdminViewDoctorPaymentHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_doctor_payment_history);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<getterSetterForBookingReq> options = new FirebaseRecyclerOptions.Builder<getterSetterForBookingReq>()
                ...
                .build();
        FirebaseRecyclerAdapter<getterSetterForBookingReq,AdminViewDoctorPaymentHistory.RequestViewHolder> adapter = new FirebaseRecyclerAdapter<getterSetterForBookingReq, AdminViewDoctorPaymentHistory.RequestViewHolder>(options)
        {
            @Override
            protected void onBindViewHolder(@NonNull final AdminViewDoctorPaymentHistory.RequestViewHolder requestViewHolder, int i, @NonNull final getterSetterForBookingReq contacts)
            {
            ...
            @NonNull
            @Override
            public AdminViewDoctorPaymentHistory.RequestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_request_inflate, parent, false);
                AdminViewDoctorPaymentHistory.RequestViewHolder holder = new AdminViewDoctorPaymentHistory.RequestViewHolder(view);
