...
public class AdminManagePatientAppointmentHistory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_manage_patient_appointment_history);
    ...
    protected void onStart() {
        ...
        FirebaseRecyclerOptions<getterSetterForBookingReq> options = new FirebaseRecyclerOptions.Builder<getterSetterForBookingReq>()
                ...
                .build();
        FirebaseRecyclerAdapter<getterSetterForBookingReq, AdminManagePatientAppointmentHistory.RequestViewHolder> adapter = new FirebaseRecyclerAdapter<getterSetterForBookingReq, AdminManagePatientAppointmentHistory.RequestViewHolder>(options)
        {
            @Override
            protected void onBindViewHolder(@NonNull final AdminManagePatientAppointmentHistory.RequestViewHolder requestViewHolder, final int i, @NonNull final getterSetterForBookingReq contacts)
            {
            ...
            @NonNull
            @Override
            public AdminManagePatientAppointmentHistory.RequestViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.chat_request_inflate, parent, false);
                AdminManagePatientAppointmentHistory.RequestViewHolder holder = new AdminManagePatientAppointmentHistory.RequestViewHolder(view);
